...
CREATE TABLE `category` (
  ...
  `sex` enum('male','female','both') COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `customer` (
  `id` int NOT NULL,
  `name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `sex` enum('male','female','orther') COLLATE utf8_unicode_ci NOT NULL,
  `location` varchar(450) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2021-04-19 11:32:01
